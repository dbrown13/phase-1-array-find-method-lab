...
const record2 = [{ year: "1961", result: "N/A"},
{ year: "1960", result: "N/A"}];

function superbowlWin(yearsAndResults) {
    let returnValue = yearsAndResults.find(isWin);
    if (returnValue) {
        returnValue = yearsAndResults.find(isWin).year;
    }
    return returnValue;
}
...
const obj2 = superbowlWin(record2);
//const result = record.find(year);
// const result2 = record2.find(year);